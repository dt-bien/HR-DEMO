        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NamePos = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Position_Department_DepId",
                        column: x => x.DepId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdEmp = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmpInfo_Position_PosId",
                        column: x => x.PosId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OTSalary = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    Bonus = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Salary_Month_MonthId",
                        column: x => x.MonthId,
                        principalTable: "Month",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Salary_Position_PosId",
                        column: x => x.PosId,
                        principalTable: "Position",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OffDay_EmpInfo_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthsSalary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthsSalary_EmpInfo_EmpId",
                        column: x => x.EmpId,
                        principalTable: "EmpInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MonthsSalary_Salary_SalaryId",
                        column: x => x.SalaryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Department_DepId",
                table: "Department",
                column: "DepId",
                unique: true,
                filter: "[DepId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_EmpInfo_IdEmp",
                table: "EmpInfo",
                column: "IdEmp",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmpInfo_PosId",
                table: "EmpInfo",
                column: "PosId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthsSalary_EmpId",
                table: "MonthsSalary",
                column: "EmpId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthsSalary_SalaryId",
                table: "MonthsSalary",
                column: "SalaryId");

            migrationBuilder.CreateIndex(
                name: "IX_OffDay_EmployeeId",
                table: "OffDay",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Position_DepId",
                table: "Position",
                column: "DepId");

            migrationBuilder.CreateIndex(
                name: "IX_Position_NamePos",
                table: "Position",
                column: "NamePos",
                unique: true);
